...
const Character = ({ name, height, hair, gender, imgUrl, birth, death, race, realm, spouse }) => {
    return (
        <div data-test='component-character'>
            <h1 data-test='char-name'>{name}</h1>
            <img data-test='char-img'  src={imgUrl} alt="picture of character"></img>
            <ul data-test='char-list'>
                ...
                <li data-test='char-realm'>Realm:{race}</li>
